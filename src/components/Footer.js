    ...
    <footer className="footer">
      <Container>
        <Row className="align-items-center">
          ...
          <Col size={12} sm={6} className="text-center text-sm-end">
            <div className="social-icon"> 
              <a href="https://www.linkedin.com/in/felix-g-b9aaa6217/" target="_linkedin">
                <img src={navIcon1} alt="Icon" />
              </a>
              <a href="https://www.facebook.com/FelixG28" target="_facebook">
                <img src={navIcon2} alt="Icon" />
              </a>
              <a href="https://www.instagram.com/glix29/" target="_instagram">
                <img src={navIcon3} alt="Icon" />
              </a>
            </div>
            <p>© {new Date().getFullYear()} DevFelix. All Rights Reserved</p>
          </Col>
        </Row>
      </Container>
    </footer>
